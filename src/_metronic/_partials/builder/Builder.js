    ...
    <>
      <Notice svg="/media/svg/icons/Tools/Compass.svg">
        <p>
          ...
          specifications and preview it in real time. The configured layout options will be saved
          until you change or reset them. To use the layout builder, choose the layout options and
          click the <code>Preview</code> button to preview the changes.
        </p>
      </Notice>
                ...
                <div className="card-body">
                  <div className="tab-content pt-3">
                    <div className={`tab-pane ${key === 0 ? 'active' : ''}`}>
                      <div className="form-group row">
                        ...
                        <div className="col-lg-9 col-xl-4">
                          ...
                          />
                          <FormHelperText>Enable fixed header for mobile mode</FormHelperText>
                        </div>
                      </div>
                      ...
                      <div className="form-group row">
                        ...
                        <div className="col-lg-9 col-xl-4">
                          ...
                          <FormHelperText>Select header menu layout style</FormHelperText>
                        </div>
                      </div>
                      ...
                      <div className="form-group row">
                        ...
                        <div className="col-lg-9 col-xl-4">
                          ...
                          />
                          <FormHelperText>Enable header menu root link arrows</FormHelperText>
                        </div>
                      </div>
                    </div>
                    <div className={`tab-pane ${key === 1 ? 'active' : ''}`}>
                      ...
                      <div className="form-group row">
                        ...
                        <div className="col-lg-9 col-xl-4">
                          ...
                          />
                          <FormHelperText>
                            Enable fixed(sticky) subheader. Requires <code>Solid</code> subheader
                            style.
                          </FormHelperText>
                        </div>
                      </div>
                      ...
                      <div className="form-group row">
                        <label className="col-lg-3 col-form-label text-lg-right">Width:</label>
                        <div className="col-lg-9 col-xl-4">
                          <select
                            className="form-control"
                          ...
                          <FormHelperText>Select layout width type</FormHelperText>
                        </div>
                      </div>
                      ...
                      <div className="form-group row">
                        ...
                        <div className="col-lg-9 col-xl-4">
                          ...
                          <FormHelperText>Select subheader style</FormHelperText>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className={`tab-pane ${key === 3 ? 'active' : ''}`}>
                      <div className="form-group row">
                        <label className="col-lg-3 col-form-label text-lg-right">Display:</label>
                        <div className="col-lg-9 col-xl-4">
                          <Switch
                            onBlur={handleBlur}
                            onChange={handleChange}
                      ...
                      <div className="form-group row">
                        <label className="col-lg-3 col-form-label text-lg-right">Fixed:</label>
                        <div className="col-lg-9 col-xl-4">
                          <Switch
                            onBlur={handleBlur}
                            onChange={handleChange}
                          ...
                          />
                          <FormHelperText>Set fixed aside layout</FormHelperText>
                        </div>
                      </div>

                      <div className="form-group row">
                        <label className="col-lg-3 col-form-label text-lg-right">Minimize:</label>
                        <div className="col-lg-9 col-xl-4">
                          <Switch
                            onBlur={handleBlur}
                            onChange={handleChange}
                          ...
                          />
                          <FormHelperText>Allow aside minimizing</FormHelperText>
                        </div>
                      </div>

                      <div className="form-group row">
                        <label className="col-lg-3 col-form-label text-lg-right">Hoverable:</label>
                        <div className="col-lg-9 col-xl-4">
                          <Switch
                            onBlur={handleBlur}
                            onChange={handleChange}
                            name="aside.self.minimize.hoverable"
                            checked={!!get(values, 'aside.self.minimize.hoverable')}
                          />
                          <FormHelperText>Expand Minimized Aside on hover</FormHelperText>
                        </div>
                      </div>
                      ...
                      <div className="form-group row">
                        ...
                        <div className="col-lg-9 col-xl-4">
                          ...
                          />
                          <FormHelperText>Set aside minimized by default</FormHelperText>
                        </div>
                      </div>
                      ...
                      <div className="form-group row">
                        ...
                        <div className="col-lg-9 col-xl-4">
                          ...
                          />
                          <FormHelperText>
                            Select submenu toggle mode (works only when <code>Fixed Mode</code> is
                            disabled)
                          </FormHelperText>
                        </div>
                      </div>
