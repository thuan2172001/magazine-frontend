...
export class HtmlClassService {
   ...
   */
  getClasses(path: any, toString: any) {
    if (path) {
  ...
  getLogo() {
    ...
    if (brandSkin === "light") {
      return ToAbsoluteUrl("/media/logos/logoNew.png");
    } else {
      return ToAbsoluteUrl("/media/logos/logoNew.png");
    }
  }
  ...
  initLayout() {
    ...
    if (_selfBodyClass) {
      ...
      bodyClasses.forEach((cssClass: string) => document.body.classList.add(cssClass));
    }
